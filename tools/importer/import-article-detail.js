...
const PAGE_TEMPLATE = {
  name: 'article-detail',
  description: 'Article detail page with hero image and title/meta header followed by long-form body of headings, lists, tables, images, and quotes.',
  urls: [
  ...
  sections: [
    {
      id: 's0', name: 'Article hero', selector: '#main-content > section.section:nth-of-type(1)', style: null, blocks: ['columns-article'], defaultContent: [],
    },
    {
      id: 's1', name: 'Article body', selector: '#main-content > section.section:nth-of-type(2)', style: null, blocks: [], defaultContent: [],
    },
  ],
};
