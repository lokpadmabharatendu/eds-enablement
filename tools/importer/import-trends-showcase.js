...
const PAGE_TEMPLATE = {
  ...
  sections: [
    ...
    {
      id: 's1', name: 'Trend alert', selector: '#main-content > section#trends', style: null, blocks: ['cards-trend'], defaultContent: [],
    },
    {
      id: 's2', name: 'Feature', selector: '#main-content > section.section.secondary-section:nth-of-type(2)', style: 'secondary', blocks: ['columns-feature'], defaultContent: [],
    },
    {
