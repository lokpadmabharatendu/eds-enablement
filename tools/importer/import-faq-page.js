...
const PAGE_TEMPLATE = {
  ...
  sections: [
    ...
    {
      id: 's1', name: 'FAQ accordion', selector: '#main-content > section.section:nth-of-type(1)', style: null, blocks: ['accordion-faq'], defaultContent: [],
    },
    {
      id: 's2', name: 'Contact', selector: '#main-content > section.section.secondary-section:nth-of-type(2)', style: 'secondary', blocks: ['columns-contact'], defaultContent: [],
    },
    {
